...
from fxcnn.datagen.utils import angstrom2bohr, get_atom_dHf0, energy2hartree
...
class AtomConf(object):
    ...
    def dens_db(self, basis: str = "6-311++G**") -> Optional[Dict]:
        # return the database entry for density profile,
        # or None if no data is available from CCCBDB
        assert self.cccbdb_retrieved
        ae0 = self.ae0()
        if ae0 is None:
        ...
        res = {}
        res["name"] = "Density profile of %s" % self.name
        res["type"] = "dens"
...
if __name__ == "__main__":
    ...
    dbfunc = lambda obj: obj.dens_db()  # for density profile entries
